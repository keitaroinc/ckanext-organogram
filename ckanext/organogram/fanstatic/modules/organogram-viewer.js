ckan.module('organogram-viewer', function($){
    return {
        initialize: function(){
            $.ajax({url: window.location.origin + "/api/action/config_option_show?key=ckanext.organogram.file_url",
                success: function(response){
                    ...
                    if (organogram_file_url.indexOf('http://') === - 1 && organogram_file_url.indexOf('https://') === -1 ){
                        ...
                        $.ajax({url: organogram_url, success: function(_result) {
                            showOrganogram(_result)
                            }})
                    } else {
                        $.ajax({url: organogram_file_url, success: function(_result) {
                        showOrganogram(_result)
                        }})
                    }    
            }})
